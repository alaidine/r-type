...
void WaveManager::GenerateWave(unsigned int waveIndex) {
  ...
  switch (waveIndex % 6) {
  case 0:
    mainPattern = MovementPattern::LINEAR;
    break;
  case 1:
    mainPattern = MovementPattern::SINUSOIDAL;
    break;
  case 2:
    mainPattern = MovementPattern::ZIGZAG;
    break;
  case 3:
    mainPattern = MovementPattern::CIRCULAR;
    break;
  case 4:
    mainPattern = MovementPattern::DIVE;
    break;
  case 5:
    mainPattern = MovementPattern::FIGURE8;
    break;
  default:
    mainPattern = MovementPattern::LINEAR;
    break;
  ...
  // Délai avant prochaine vague (diminue avec la difficulté, minimum 5
  // secondes)
  wave.delayBeforeNextWave = 8.0f - (waveIndex * 0.3f);
  if (wave.delayBeforeNextWave < 5.0f)
    wave.delayBeforeNextWave = 5.0f;
...
bool WaveManager::IsWaveActive(void) const { return this->_waveActive; }
...
bool WaveManager::IsGameStarted(void) const { return this->_gameStarted; }

void WaveManager::Reset(void) { Init(); }
