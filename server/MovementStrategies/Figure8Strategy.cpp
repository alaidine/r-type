...
Figure8Strategy::Figure8Strategy(float xSpeed, float width, float height,
                                 float speed, float startX, float centerY)
    : _xSpeed(xSpeed), _width(width), _height(height), _speed(speed),
      _startX(startX), _centerY(centerY) {}

Position
Figure8Strategy::update([[maybe_unused]] const Position &currentPosition,
                        float totalTime) {
