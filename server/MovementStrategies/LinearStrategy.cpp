...
LinearStrategy::LinearStrategy(float xSpeed, float ySpeed, float startX, float startY)
    : _xSpeed(xSpeed), _ySpeed(ySpeed), _startX(startX), _startY(startY)
{
}

Position LinearStrategy::update([[maybe_unused]] const Position &currentPosition, float totalTime)
{
