    ...
    public:
        void Update() override {
            ...
            for (auto const& entity: _entities) {
                ...
                rec = {pos.position.x, pos.position.y, anim.rect.width * 2.0f, anim.rect.height * 2.0f};
                destrec = {pos.position.x, pos.position.y, anim.rect.width * 2.0f, anim.rect.height * 2.0f};
